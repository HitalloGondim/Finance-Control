...
@__DSOCacheEntry_name.25 = internal constant [30 x i8] c"libaot-Finance Control.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 29
	%struct.DSOCacheEntry {
		i64 314485305, ; hash 0x12beaa39, from name: libaot-Finance Control
		i8 0, ; ignore
	...
	; 77
	%struct.DSOCacheEntry {
		i64 835562281, ; hash 0x31cdab29, from name: aot-Finance Control
		i8 0, ; ignore
		i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__DSOCacheEntry_name.25, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 144
	%struct.DSOCacheEntry {
		i64 1394478960, ; hash 0x531e0f70, from name: Finance Control.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__DSOCacheEntry_name.25, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 299
	%struct.DSOCacheEntry {
		i64 2790733369, ; hash 0xa6573639, from name: Finance Control
		i8 0, ; ignore
		i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__DSOCacheEntry_name.25, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 335
	%struct.DSOCacheEntry {
		i64 3049314376, ; hash 0xb5c0d848, from name: aot-Finance Control.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__DSOCacheEntry_name.25, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 447
	%struct.DSOCacheEntry {
		i64 4168236810, ; hash 0xf8723f0a, from name: libaot-Finance Control.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__DSOCacheEntry_name.25, i32 0, i32 0), ; name
		i8* null; handle
	}, 
